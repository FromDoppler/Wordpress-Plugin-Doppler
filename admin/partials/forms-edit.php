            ...
            <div class="dplr_input_section">
              ...
              <div class="form_orientation">
                <div style="display: flex; align-items: center;">
                  ...
                  <input type="radio" name="settings[form_orientation]" value="vertical" <?php if(isset($form->settings['form_orientation']) && $form->settings['form_orientation']==='vertical') echo 'checked'?> />
                </div>
                <div style="display: flex; align-items: center;">
                  <label for="horizontal"><?php _e('Horizontal','doppler-form')?></label>
                  <input type="radio" name="settings[form_orientation]" value="horizontal" <?php if(isset($form->settings['form_orientation']) && $form->settings['form_orientation']==='horizontal') echo 'checked'?> />
                </div>
              </div>
            </div>
