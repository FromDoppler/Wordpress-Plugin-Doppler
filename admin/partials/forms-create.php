          ...
          <div class="dplr_input_section" id="section_pagina_confirmacion">
            <h2><?php _e('Confirmation page', 'doppler-form');?></h2>
              ...
              <div id="div_url_destino">
                ...
                <input type="text" id="form_pagina_confirmacion_url" name="settings[form_pagina_confirmacion_url]" value="<?php echo isset($form['settings']["form_pagina_confirmacion_url"])?$form['settings']["form_pagina_confirmacion_url"]:'' ?>" placeholder="<?php _e('Example: https://www.fromdoppler.com', 'doppler-form')?>" maxlength="40"/>
              </div>
