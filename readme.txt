...
= 2.4.8 =
* Fix: validate content when on code editor for double optin forms.
* Fix: remove default escape slashing for doble optin content.

= 2.4.7 =
* Fix: broken access control vulnerability
* Update: Add open graph section to settings.

= 2.4.6 =
* Fix: fix XSS vulnerability
* Update: Modify tracking section to settings.
* Update: Add loading screen to wait for style library.
* Fix: Woocommerce contacts counter.
...
= 2.4.3 =
* Feat: Allow to display forms in a Elementor's pop up.

= 2.4.2 =
* Fix: Fix style conflic with plugins section

= 2.4.1 =
* Update: Apply Doppler's styles library
...
* Fix: Improvement on form's list view.
* Fix: Fixed translations.
* Fix: Fix for submittion error when there were wrong fields on double optin forms.
...
= 2.3.3 =
* Fix error when submiting forms in some scenarios.
